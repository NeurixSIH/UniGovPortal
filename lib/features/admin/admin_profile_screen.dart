...
class _AdminProfileScreenState extends State<AdminProfileScreen> {
  late TextEditingController _adminIdentityCtrl;
  late TextEditingController _adminEmailCtrl;
  late TextEditingController _adminAccessCtrl;
  late TextEditingController _admin2FaCtrl;

  @override
  void initState() {
    super.initState();
    _adminIdentityCtrl = TextEditingController(text: 'Vikram Sen (EMP-NIC-9041)');
    _adminEmailCtrl = TextEditingController(text: 'vikram.sen@nic.in');
    _adminAccessCtrl = TextEditingController(text: 'Level 5 (Unrestricted SuperAdmin)');
    _admin2FaCtrl = TextEditingController(text: 'FIDO2 Hardware Key (Active)');
  }

  @override
  void dispose() {
    _adminIdentityCtrl.dispose();
    _adminEmailCtrl.dispose();
    _adminAccessCtrl.dispose();
        ...
        child: ConstrainedBox(
          ...
          child: Column(
            ...
            children: [
              ...
              Text('Root administration rights, security keys, and system log auditing.', style: AppTypography.bodySmall),
                          ...
                          Expanded(
                            child: Column(
                              ...
                              children: [
                                ...
                                Text(
                                  'Super Administrator • National Informatics Centre (NIC)',
                                  style: AppTypography.bodySmall.copyWith(color: AppColors.primaryAccent),
                                ),
                                const SizedBox(height: 4),
                                Text(
                                  'Emp ID: NIC-ADM-9041 • Cleared Security Clearance Level A1',
