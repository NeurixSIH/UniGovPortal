          ...
          child: Column(
            children: [
              ...
              Expanded(
                child: Center(
                  child: Container(
                    width: isWide ? 412 : screenSize.width,
                    constraints: const BoxConstraints(maxWidth: 430),
                    margin: isWide ? const EdgeInsets.only(bottom: 12) : EdgeInsets.zero,
                    decoration: BoxDecoration(
                      color: AppTheme.backgroundLight,
                      borderRadius: isWide ? BorderRadius.circular(44) : BorderRadius.zero,
                      border: isWide
                          ? Border.all(color: const Color(0xFF334155), width: 7)
                          : null,
                      boxShadow: isWide
                          ? [
                              BoxShadow(
